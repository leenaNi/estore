        ...
        <div class="col-xs-12">
            <div class="nav-tabs-custom box-info"> 
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="{{ in_array(Route::currentRouteName(),['admin.masters.category.addEdit']) ? 'active' : '' }}"><a href="{!! route('admin.masters.category.addEdit',['id'=>Input::get('id')]) !!}"  aria-expanded="false">Category Add/Edit</a></li>
                    @endif
                    <li class="{{ in_array(Route::currentRouteName(),['admin.masters.matsterCategories']) ? 'active' : '' }}"><a href="{!! (Input::get('id'))?route('admin.masters.matsterCategories',['id'=>Input::get('id')]):'#' !!}" aria-expanded="false">Assign Categories</a></li>
                </ul>
