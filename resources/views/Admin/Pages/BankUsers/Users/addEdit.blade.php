...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li><a href="{{ route('admin.bankusers.users.view') }}"><i class="fa fa-dashboard"></i>Users</a></li>
        ...
        <div class="col-xs-12">
            <div class="box pt50">
                <div class="box-body">
                    ...
                    {!! Form::model($vuser, ['method' => 'post', 'route' => $action , 'class' => 'form-horizontal','id'=>'userFormB' ]) !!}
