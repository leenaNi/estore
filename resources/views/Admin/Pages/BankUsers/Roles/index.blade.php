                ...
                <div class="box-header">
                    <div class="row">
                        ...
                        <div class="col-md-2 text-right"> 
                            {!! Form::open(['route'=>'admin.bankusers.roles.addEdit','method'=>'post']) !!}
...
<!--                                <td>{{$role->id}}</td>-->
                                ...
                                <td>{{date('d-M-Y',strtotime($role->description)) }}</td>
                                <td>
                                    <a href="{{ route('admin.bankusers.roles.addEdit') }}?id={{$role->id}}" target="_" class="label label-success active" ui-toggle-class="">Edit</a>
                                </td>
                                <td>
<!--                                    <a href="{{ route('admin.bankusers.roles.delete') }}?id={{$role->id}}" target="_" class="label label-danger active" ui-toggle-class="">Delete</a>-->
                                </td>
