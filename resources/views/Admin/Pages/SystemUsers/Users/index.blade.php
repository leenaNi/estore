                ...
                <div class="box-header">
                    <div class="row">
                        ...
                        <div class="col-md-2 text-right"> 
                            {!! Form::open(['route'=>'admin.systemusers.users.addEdit','method'=>'post']) !!}
...
<!--                                <td>{{$user->id}}</td>-->
                                ...
                                <td>
                                    <a href="{{ route('admin.systemusers.users.addEdit') }}?id={{$user->id }}" class="label label-success active" ui-toggle-class="">Edit</a>
                                </td>

                                <td>
                                    <!--                                    <a href="{{ route('admin.systemusers.users.delete') }}?id={{$user->id }}" onclick="return confirm('Are you sure you want to continue?')" class="label label-success active" ui-toggle-class="">Delete</a>-->
                                </td>
                            </tr>
