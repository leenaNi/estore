...
<header id="header" class="transparent-header">
    ...
    <div id="header-wrap">
        ...
        <div class="container clearfix">
            ...
            ============================================= -->
            <div id="logo">
                <a href="/" class="standard-logo" data-dark-logo="{{ asset(Config('constants.frontendPublicImgPath').'/logo2.png') }}"><img src="{{ asset(Config('constants.frontendPublicImgPath').'/logo2.png') }}" alt="VeeStores"></a>
                <a href="/" class="retina-logo" data-dark-logo="{{ asset(Config('constants.frontendPublicImgPath').'/logo2.png') }}"><img src="{{ asset(Config('constants.frontendPublicImgPath').'/logo2.png') }}" alt="VeeStores"></a>
            </div><!-- #logo end -->
