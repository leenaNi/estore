...
<header id="header" class="transparent-header">
    ...
    <div id="header-wrap">
        ...
        <div class="container clearfix">
            ...
            ============================================= -->
            <div id="logo">
                <a href="/" class="standard-logo" data-dark-logo="{{ asset(Config('constants.frontendPublicEstorifiImgPath').'/logo2.png') }}"><img src="{{ asset(Config('constants.frontendPublicEstorifiImgPath').'/logo2.png') }}" alt="eStorifi"></a>
                <a href="/" class="retina-logo" data-dark-logo="{{ asset(Config('constants.frontendPublicEstorifiImgPath').'/logo2.png') }}"><img src="{{ asset(Config('constants.frontendPublicEstorifiImgPath').'/logo2.png') }}" alt="eStorifi"></a>
            </div><!-- #logo end -->
