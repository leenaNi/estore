                                                    ...
                                                    <table class="shop_table cart table table-bordered" cellspacing="0">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="product-price" style="width:20%;">Order Amount</th>
                                                                <th class="product-quantity" style="width:20%;">Cashback Earned</th>
                                                                <th class="product-subtotal" style="width:20%;">Received On</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            ...
                                                            <tr class="cart_item">
                                                                ...
                                                                <td class="">
                                                                    <span class="cart-item-details">{{ $ord->order_amt }}</span>                   
                                                                </td>
                                                                <td class="">
                                                                    <div class="cart-item-details">{{ $ord->cashback_earned }}</div>
                                                                </td>
                                                                <td class="product-subtotal">
                                                                    <span class="amount">{{ date("d-M-Y",strtotime($ord->updated_at)) }}</span>               
                                                                </td>
                                                            </tr>
                                                            @endforeach
                                                        </tbody>
