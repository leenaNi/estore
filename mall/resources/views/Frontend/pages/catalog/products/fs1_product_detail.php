          ...
          <div class="single-product">
            <div class="product">
              ...
              <div class="col_last col_half product-desc">
                ...
                <div class="product-price"> <del><?php echo htmlspecialchars_decode(Session::get('currency_symbol')); ?> 499</del> <ins><?php echo htmlspecialchars_decode(Session::get('currency_symbol')); ?> 399</ins></div> <span class="span2" style="color:red;">STOCK LEFT - 6</span>
                <div class="clear"></div>
                <div class="line"></div>
              ...
              <div class="oc-item">
                <div class="product clearfix mobwidth100">
                  ...
                  <div class="product-desc">
                    ...
                    <div class="product-price"><del><?php echo htmlspecialchars_decode(Session::get('currency_symbol')); ?> 499</del> <ins><?php echo htmlspecialchars_decode(Session::get('currency_symbol')); ?> 399</ins> </div>
                  </div>
                </div>
              </div>
              <div class="oc-item">
