...
//                                                    dd($prdimg);
                                                    ...
                                                    <div class="slide" data-thumb="{{$prdimg->img}}">
                                                        <a href="{{$prdimg->img}}" title="{{$product->product}}" data-lightbox="gallery-item"><img src="{{$prdimg->img}}" alt="{{ $prdimg->alt_text }}" class="zoom-me zoom-me1 {{ ($pk == 0)?'fimg':''  }} " data-zoom-image="{{$prdimg->img}}"> </a>
                                                    </div>
