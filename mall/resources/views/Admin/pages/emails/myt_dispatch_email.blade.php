        ...
        <table width="900" border="0" align="center" cellpadding="10" cellspacing="0" style="font-family:Source Sans Pro Light, Geneva, sans-serif;">
            ...
            <tr>
                <td align="left" valign="top" style="color:#58595B; text-align:justify; font-family:Source Sans Pro Light, Geneva, sans-serif;">
                    This is to inform you that your order has been dispatched from our warehouse. <br/>
        ...
        <a href="#">Click here</a>
                    ...
                    <table border="0" cellspacing="0" cellpadding="12" style="border:1px dashed #ccc; border-radius:10px; width:100%; font-family:Source Sans Pro Light, Geneva, sans-serif;">
                       ...
                       // print_r($prods);
                        ...
                        <tr>
                            ...
                            <td  valign="top" align="right" style="color:#58595B; border-right:1px dashed #ccc; border-bottom:1px dashed #ccc;">{{ $prod['value']}}</td>


                            <td  valign="top" align="right" style="color:#58595B; border-right:1px dashed #ccc; border-bottom:1px dashed #ccc;">Rs.{{ number_format($order->prod_price) }}</td>
                        ...
                        @endforeach
                        <tr>
                            <td colspan="3" align="right" style="color:#58595B; border-right:1px dashed #ccc; border-bottom:1px dashed #ccc;font-family:Source Sans Pro, Geneva, sans-serif;" ><strong>SUB-TOTAL</strong></td>
                            <td align="right" style="color:#58595B; border-bottom:1px dashed #ccc;">Rs.{{ number_format($order->order_amount)  }}</td>
                        </tr>
                        <tr>
                            <td colspan="3" align="right"  style="color:#58595B; border-right:1px dashed #ccc; border-bottom:1px dashed #ccc; font-family:Source Sans Pro, Geneva, sans-serif;"><strong>DISCOUNT</strong></td>
                            <td align="right" style="color:#58595B; border-bottom:1px dashed #ccc;">Rs.{{number_format($order->final_amount - $order->order_amount)  }}</td>
                        </tr>


                        <tr>
                            <td colspan="3" align="right"  style="color:#58595B; border-right:1px dashed #ccc; font-family:Source Sans Pro, Geneva, sans-serif;"><strong>TOTAL</strong></td>
            ...
            <tr>
                <td style="color:#58595B;">
                    ...
                    <p>You have earned <strong>0</strong> reward points with this purchase. Your reward points will be added to your wallet which can be redeemed on your future purchases. You can check your current reward points by logging into your account.</p>
