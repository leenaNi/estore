...
This is to inform you that your order exchange request has been processed and your order has been dispatched from our warehouse.
        ...
        <tr>    
                <td style="color:#58595B;">
                    <h5> 
                        ...
                        Tracking Number:  {{ $orderUser->myt_shiplabel_tracking_id }}
                    </h5>
                ...
                <td style="color:#58595B;">
                    ...
                    <p>Orders within India are delivered within 7 - 8 working days, and International orders are delivered within 10 to 15 working days. Delivery time may vary depending upon the shipping address. Please note that this is the maximum time for delivery.</p>
            ...
            <tr>
                <td style="color:#58595B;">Have a great day.<br/>
                     Cartini Team</td>
            </tr>
