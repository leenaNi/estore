                    ...
                    <table class="table table-striped table-hover tableVaglignMiddle">
                        ...
                        <tbody>
                            ...
                            <tr> 
                                ...
                                <td>
                                    <a href="{!! route('admin.paymentSetting.edit',['url_key'=>$set->url_key,'type'=>3]) !!}" data-toggle="tooltip" title="Configure" ui-toggle-class=""><i class="fa fa-cog btnNo-margn-padd" aria-hidden="true"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
