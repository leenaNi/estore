...
<style>
    ...
    .ui-rotatable-handle {
        ...
        width: 16px;
        cursor: pointer;
        background-image: url(http://godswearhats.com/jquery-ui-rotatable/rotate.png);
        background-size: 100%;
        left: 5px;
        bottom: 5px;
        position: absolute;
...
@section('myscripts')
<script src='http://godswearhats.com/jquery-ui-rotatable/jquery.ui.rotatable.js'></script>
<script>
