        ...
        foreach ($orderIds as $id) {
            if ($id > 0) {
                ...
                if ($orderStatus == 8) {
                    ...
                    $msgS = "Hey, this is to inform you that we're facing a slight delay with your 
    order & we're doing our best to get it to you as soon as possible. Have a soulful day!";
