                    ...
                    if (count($storeIds) > 0) {
                        ...
                        if (count($storeUserIds) > 0) {
                            ...
                            //->select('orders.*')
                                ...
                                ->get(['has_products.id', 'has_products.order_id', 'has_products.prod_id', 'has_products.sub_prod_id', 'has_products.qty', 'has_products.price', DB::raw('concat("' . $productImgPath. '", catalog_images.filename) as productImg')]);
