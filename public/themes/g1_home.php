        ...
        <div class="fslider" data-arrows="true" data-pagi="false">
          <div class="flexslider">
            <div class="slider-wrap">
              <div class="slide">
                <a href="#"> <img src="images/others/slider/4.jpg" alt=""> 
                <div class="flex-caption">
                    <h2>Fruits & Vegetables</h2>
                </div></a>
              </div>
              <div class="slide">
                <a href="#"> <img src="images/others/slider/5.jpg" alt=""> 
                <div class="flex-caption">
                    <h2>Body Products</h2>
                </div></a>
              </div>
              <div class="slide">
                <a href="#"> <img src="images/others/slider/6.jpg" alt=""> 
                <div class="flex-caption">
                    <h2>Proteins & Chocolates</h2>
                </div></a>
              </div>
            </div>
          </div>
      ...
      <div class="content-wrap">
        <div class="container clearfix">
          <div class="col_one_third">
            ...
            <a href="fs1_product_listing.php"><img src="images/grocery/1.jpg" alt="">
            </a>
            <div class="overlayContentBox">
                <div>
                    <h3 class="nobottommargin text-center">Grains</h3>
                </div>
            </div>
          </div>
          <div class="col_one_third">
            <a href="fs1_product_listing.php"><img src="images/grocery/2.jpg" alt="">
            </a>
            <div class="overlayContentBox">
                <div>
                    <h3 class="nobottommargin text-center">Spices</h3>
                </div>
            </div>
          </div>
          <div class="col_one_third col_last">
            <a href="fs1_product_listing.php"><img src="images/grocery/3.jpg" alt="">
            </a>
            <div class="overlayContentBox">
              <div>
                  <h3 class="nobottommargin text-center">Dairy</h3>
              </div>
          </div>
          </div>
        </div>
