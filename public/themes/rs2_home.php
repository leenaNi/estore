            ...
            <div class="container clearfix topmargin-sm">
                    ...
                    <div class="fslider" data-arrows="false">
                        <div class="flexslider">
                            <div class="slider-wrap">
                                <div class="slide">
                                    <a href="#"> <img src="images/restaurant/slider/1.jpg" alt="Shop Image"> 
                                        <div class="flex-caption">
                                            <h2>Food is Fuel Not Therapy</h2>
                                        </div></a>
                                </div>
                                <div class="slide">
                                    <a href="#"> <img src="images/restaurant/slider/2.jpg" alt="Shop Image"> 
                                        <div class="flex-caption">
                                            <h2>Food is Love</h2>
                                        </div></a>
                                </div>
                                <div class="slide">
                                    <a href="#"> <img src="images/restaurant/slider/3.jpg" alt="Shop Image"> 
                                        <div class="flex-caption">
                ...
                <div class="col_one_fourth nobottommargin col_last">
                    ...
                    <div class="col_full bottommargin-26">
                        <a href="#"><img src="images/restaurant/featurebox/1.jpg" alt="">
                        </a>
                        <div class="overlayContentBox">
                            <div>
                                <h3 class="nobottommargin text-center">For Foodies</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col_full bottommargin-26">
                        <a href="#"><img src="images/restaurant/featurebox/2.jpg" alt="">
                        </a>
                        <div class="overlayContentBox">
                            <div>
                                <h3 class="nobottommargin text-center">Time to EAT</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col_full bottommargin-sm">
                        <a href="#"><img src="images/restaurant/featurebox/3.jpg" alt="">
                        </a>
                        <div class="overlayContentBox">
                            <div>
                                <h3 class="nobottommargin text-center">Yummy Food</h3>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="shop" class="shop clearfix">
                            ...
                            <div class="product clearfix product-item productbox">
                                <div class="product-image">
                                    <a href="#"><img src="images/restaurant/products/default-product.jpg" alt="">
                                    </a>
