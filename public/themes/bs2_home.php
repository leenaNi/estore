            ...
            <div class="container clearfix topmargin-sm">
                    ...
                    <div class="fslider" data-arrows="false">
                        <div class="flexslider">
                            <div class="slider-wrap">
                                <div class="slide">
                                    <a href="#"> <img src="images/books-stationery/slider/1.jpg" alt="Shop Image"> 
                                        <div class="flex-caption">
                                            <h2>Knowledge lies in Books</h2>
                                        </div></a>
                                </div>
                                <div class="slide">
                                    <a href="#"> <img src="images/books-stationery/slider/2.jpg" alt="Shop Image"> 
                                        <div class="flex-caption">
                                            <h2>Books are a uniquely portable magic</h2>
                                        </div></a>
                                </div>
                                <div class="slide">
                                    <a href="#"> <img src="images/books-stationery/slider/3.jpg" alt="Shop Image"> 
                                        <div class="flex-caption">
                                            <h2>A good book is lyk a good journey</h2>
                                        </div></a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col_one_fourth nobottommargin col_last">
                    ...
                    <div class="col_full bottommargin-26">
                        <a href="#"><img src="images/books-stationery/featurebox/1.jpg" alt="">
                        </a>
                        <div class="overlayContentBox">
                            <div>
                                <h3 class="nobottommargin text-center">Stationery at 20 % off</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col_full bottommargin-26">
                        <a href="#"><img src="images/books-stationery/featurebox/2.jpg" alt="">
                        </a>
                        <div class="overlayContentBox">
                            <div>
                                <h3 class="nobottommargin text-center">Notebooks</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col_full bottommargin-sm">
                        <a href="#"><img src="images/books-stationery/featurebox/3.jpg" alt="">
                        </a>
                        <div class="overlayContentBox">
                            <div>
                                <h3 class="nobottommargin text-center">Get Creative</h3>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="shop" class="shop clearfix">
                            ...
                            <div class="product clearfix product-item productbox">
                                <div class="product-image">
                                    <a href="#"><img src="images/books-stationery/products/default-product.jpg" alt="">
                                    </a>
