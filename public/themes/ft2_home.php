            ...
            <div class="container clearfix topmargin-sm">
                    ...
                    <div class="fslider" data-arrows="false">
                        <div class="flexslider">
                            <div class="slider-wrap">
                                <div class="slide">
                                    <a href="#"> <img src="images/footwear/slider/1.jpg" alt="Shop Image"> 
                                        <div class="flex-caption">
                                            <h2>Keep your head & heels high</h2>
                                        </div></a>
                                </div>
                                <div class="slide">
                                    <a href="#"> <img src="images/footwear/slider/2.jpg" alt="Shop Image"> 
                                        <div class="flex-caption">
                                            <h2>If the shoe fits, get another one just like it</h2>
                                        </div></a>
                                </div>
                                <div class="slide">
                                    <a href="#"> <img src="images/footwear/slider/3.jpg" alt="Shop Image"> 
                                        <div class="flex-caption">
                                            <h2>You put high heels on and you change</h2>
                                        </div></a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col_one_fourth nobottommargin col_last">
                    ...
                    <div class="col_full bottommargin-26">
                        <a href="f#"><img src="images/footwear/featurebox/1.jpg" alt="">
                        </a>
                        <div class="overlayContentBox">
                            <div>
                                <h3 class="nobottommargin text-center">Fit for you</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col_full bottommargin-26">
                        <a href="f#"><img src="images/footwear/featurebox/2.jpg" alt="">
                        </a>
                        <div class="overlayContentBox">
                            <div>
                                <h3 class="nobottommargin text-center">Rain Wear</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col_full bottommargin-sm">
                        <a href="f#"><img src="images/footwear/featurebox/3.jpg" alt="">
                        </a>
                        <div class="overlayContentBox">
                            <div>
                                <h3 class="nobottommargin text-center">Colorful is the new trend</h3>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="shop" class="shop clearfix">
                            ...
                            <div class="product clearfix product-item productbox">
                                <div class="product-image">
                                    <a href="#.php"><img src="images/footwear/products/default-product.jpg" alt="">
                                    </a>
                                ...
                                <div class="product-desc product-desc-transparent">
                                    <div class="product-title"><h3><a href="#.php">Your Product Name</a></h3></div>
                                    <div class="product-price"><del><i class="icon-rupee"></i> 499</del> <ins><i class="icon-rupee"></i> 399</ins></div>
                                </div>
                                <div class="add-to-cart-btn">
                                    <a href="#.php" class="button button-grey full-width-btn"><span>View Detail</span></a>
                                </div>
                            </div>
                            ...
                            <div class="product clearfix product-item productbox">
                                ...
                                <div class="product-desc product-desc-transparent">
                                    <div class="product-title"><h3><a href="#.php">Your Product Name</a></div>
                                    <div class="product-price"><del><i class="icon-rupee"></i> 499</del> <ins><i class="icon-rupee"></i> 399</ins></div>
                                </div>
                                <div class="add-to-cart-btn">
                                    <a href="#.php" class="button button-grey full-width-btn"><span>View Detail</span></a>
