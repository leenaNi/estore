            ...
            <div class="container clearfix topmargin-sm">
                    ...
                    <div class="fslider" data-arrows="false">
                        <div class="flexslider">
                            <div class="slider-wrap">
                                <div class="slide">
                                    <a href="#"> <img src="images/toys-sports/slider/1.jpg" alt="Shop Image"> 
                                        <div class="flex-caption">
                                            <h2>Stay fit, Stay Healthy</h2>
                                        </div></a>
                                </div>
                                <div class="slide">
                                    <a href="#"> <img src="images/toys-sports/slider/2.jpg" alt="Shop Image"> 
                                        <div class="flex-caption">
                                            <h2>Fitness is the key to success</h2>
                                        </div></a>
                                </div>
                                <div class="slide">
                                    <a href="#"> <img src="images/toys-sports/slider/3.jpg" alt="Shop Image"> 
                                        <div class="flex-caption">
                                            <h2>We love toys</h2>
                                        </div></a>
                                </div>
                ...
                <div class="col_one_fourth nobottommargin col_last">
                    ...
                    <div class="col_full bottommargin-26">
                        <a href="#"><img src="images/toys-sports/featurebox/1.jpg" alt="">
                        </a>
                        <div class="overlayContentBox">
                            <div>
                                <h3 class="nobottommargin text-center">Stay Fit</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col_full bottommargin-26">
                        <a href="#"><img src="images/toys-sports/featurebox/2.jpg" alt="">
                        </a>
                        <div class="overlayContentBox">
                            <div>
                                <h3 class="nobottommargin text-center">Run for Fun</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col_full bottommargin-sm">
                        <a href="#"><img src="images/toys-sports/featurebox/3.jpg" alt="">
                        </a>
                        <div class="overlayContentBox">
                            <div>
                        ...
                        <div id="shop" class="shop clearfix">
                            ...
                            <div class="product clearfix product-item productbox">
                                <div class="product-image">
                                    <a href="#"><img src="images/toys-sports/products/default-product.jpg" alt="">
                                    </a>
