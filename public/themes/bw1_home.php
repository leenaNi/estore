      ...
      <div class="content-wrap">
        <div class="container clearfix">
          <div class="col_one_third">
            <a href="fs1_product_listing.php"><img src="images/beauty-wellness/featurebox/1.jpg" alt="">
            </a>
          ...
          <div class="col_one_third">
            <a href="fs1_product_listing.php"><img src="images/beauty-wellness/featurebox/2.jpg" alt="">
            </a>
            <div class="overlayContentBox">
                    <div>
          ...
          <div class="col_one_third col_last">
            <a href="fs1_product_listing.php"><img src="images/beauty-wellness/featurebox/3.jpg" alt="">
            </a>
            <div class="overlayContentBox">
                    <div>
          ...
          <div id="shop" class="shop clearfix">
            <div class="product clearfix">
              <div class="product-image producImgBoxSize_4Col">
                <a href="product_detail.php?theme=<?php echo $_GET['theme']; ?>"><img src="images/beauty-wellness/products/default-product.jpg" alt="">
                </a>
