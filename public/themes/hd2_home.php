            ...
            <div class="container clearfix topmargin-sm">
                    ...
                    <div class="fslider" data-arrows="false">
                        <div class="flexslider">
                            <div class="slider-wrap">
                                <div class="slide">
                                    <a href="#"> <img src="images/home-decor/slider/1.jpg" alt="Shop Image"> 
                                        <div class="flex-caption">
                                            <h2>Your thought, Our Design</h2>
                                        </div></a>
                                </div>
                                <div class="slide">
                                    <a href="#"> <img src="images/home-decor/slider/2.jpg" alt="Shop Image"> 
                                        <div class="flex-caption">
                                            <h2>Home is where you live</h2>
                                        </div></a>
                                </div>
                                <div class="slide">
                                    <a href="#"> <img src="images/home-decor/slider/3.jpg" alt="Shop Image"> 
                                        <div class="flex-caption">
                                            <h2>House + Love = Home</h2>
                                        </div></a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col_one_fourth nobottommargin col_last">
                    ...
                    <div class="col_full bottommargin-26">
                        <a href="fs2_product_listing.php"><img src="images/home-decor/featurebox/1.jpg" alt="">
                        </a>
                        <div class="overlayContentBox">
                            <div>
                                <h3 class="nobottommargin text-center">Floral World</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col_full bottommargin-26">
                        <a href="fs2_product_listing.php"><img src="images/home-decor/featurebox/2.jpg" alt="">
                        </a>
                        <div class="overlayContentBox">
                            <div>
                                <h3 class="nobottommargin text-center">Future Homes</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col_full bottommargin-sm">
                        <a href="fs2_product_listing.php"><img src="images/home-decor/featurebox/3.jpg" alt="">
                        </a>
                        <div class="overlayContentBox">
                            <div>
                                <h3 class="nobottommargin text-center">Offers Zone</h3>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="shop" class="shop clearfix">
                            ...
                            <div class="product clearfix product-item productbox">
                                <div class="product-image">
                                    <a href="#"><img src="images/home-decor/products/default-product.jpg" alt="">
                                    </a>
                                ...
                                <div class="product-desc product-desc-transparent">
                                    <div class="product-title"><h3><a href="#">Your Product Name</a></h3></div>
                            ...
                            <div class="product clearfix product-item productbox">
                                ...
                                <div class="product-desc product-desc-transparent">
                                    <div class="product-title"><h3><a href="#">Your Product Name</a></div>
                                    <div class="product-price"><del><i class="icon-rupee"></i> 499</del> <ins><i class="icon-rupee"></i> 399</ins></div>
                                </div>
                                <div class="add-to-cart-btn">
                                    <a href="#" class="button button-grey full-width-btn"><span>View Detail</span></a>
