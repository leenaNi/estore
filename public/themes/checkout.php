                      ...
                      <div class="col-md-5">
                        ...
                        <div class="summry_col">
                          <ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all" role="tablist">
                            <li>Subtotal : <span class="pull-right"> Rs. 399</span>
                            </li>
                            <li>Shipping : <span class="pull-right"> Rs. 0.00</span>
                            </li>
                            <li>Coupon : <span class="pull-right"> Rs. 0.00</span>
                            </li>
                          </ul>
                          <h4>Total <span class="amount"> <span class="pull-right TotalCartAmt amount"> Rs. 399</span></span></h4> </div>
                      </div>
                    </div>
                    <div class="clearfix"></div>
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="pymt_mtd_col">
                          ...
                          <h5>Bill Amount : <span class="amount"><b class="finalamt ng-binding">Rs. 399</b></span></h5> </div>
                      </div>
                      <div class="col-md-6">
                        <div class="summry_col">
                          ...
                          <ul ng-init="payOpt = 1">
                            ...
                            <li>
                              <div>
                                ...
                                <label for="radioCod" class="codText"> CASH ON DELIVERY (Rs.200)</label>
                              </div>
                            </li>
                          </ul>
                        </div>
