					...
					<div class="col_three_fourth nobottommargin">
						...
						<div class="fslider" data-arrows="false">
							<div class="flexslider">
								...
								<div class="slide">
                <a href="#"> <img src="images/jewellery/slider/1.jpg" alt="Shop Image"> 
                <div class="flex-caption">
                                <h2>Jewelry makes you complete</h2>
                            </div></a>
              </div>
							<div class="slide">
                <a href="#"> <img src="images/jewellery/slider/2.jpg" alt="Shop Image"> 
                <div class="flex-caption">
                                <h2>We make you feel special</h2>
                            </div></a>
              </div>
							<div class="slide">
                <a href="#"> <img src="images/jewellery/slider/3.jpg" alt="Shop Image"> 
                <div class="flex-caption">
					...
					<div class="col_one_fourth nobottommargin col_last">
						...
						<a href="fs2_product_listing.php"><img src="images/jewellery/featurebox/1.jpg" alt="">
            </a>
            <div class="overlayContentBox">
                    <div>
                        <h3 class="nobottommargin text-center">Smile Sparkle Shine</h3>
                    </div>
                </div>
						</div>
						<div class="col_full bottommargin-26">
						<a href="fs2_product_listing.php"><img src="images/jewellery/featurebox/2.jpg" alt="">
            </a>
            <div class="overlayContentBox">
                    <div>
                        <h3 class="nobottommargin text-center">Diamonds are Forever</h3>
                    </div>
                </div>
						</div>
						<div class="col_full bottommargin-sm">
						<a href="fs2_product_listing.php"><img src="images/jewellery/featurebox/3.jpg" alt="">
            </a>
            <div class="overlayContentBox">
                    <div>
                        <h3 class="nobottommargin text-center">Exclusive Collection</h3>
                    </div>
                </div>
						</div>
			...
			<div class="content-wrap">
				...
				<div id="shop" class="shop clearfix">
									<div class="product clearfix product-item productbox">
										...
										<a href="product_detail.php?theme=<?php echo $_GET['theme']; ?>"><img src="images/jewellery/products/default-product.jpg" alt="">
                </a>
