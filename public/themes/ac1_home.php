        ...
        <div class="fslider" data-arrows="true" data-pagi="false">
          <div class="flexslider">
            <div class="slider-wrap">
              <div class="slide">
                <a href="#"> <img src="images/artncraft/slider/1.jpg" alt="Shop Image"> 
                <div class="flex-caption">
                                <h2>Luxury Dress for Confident Women</h2>
                            </div></a>
              </div>
              <div class="slide">
                <a href="#"> <img src="images/artncraft/slider/2.jpg" alt="Shop Image"> 
                <div class="flex-caption">
                                <h2>Get in Action with <br/>Street Style Inspiration</h2>
                            </div></a>
              </div>
              <div class="slide">
                <a href="#"> <img src="images/artncraft/slider/3.jpg" alt="Shop Image"> 
                <div class="flex-caption">
                                <h2>Get Your Glam On!</h2>
                            </div></a>
              </div>
            </div>
          </div>
      ...
      <div class="content-wrap">
        <div class="container clearfix">
          <div class="col_one_third">
            <a href="fs1_product_listing.php"><img src="images/artncraft/featurebox/1.jpg" alt="">
            </a>
            <div class="overlayContentBox">
                    <div>
                        <h3 class="nobottommargin text-center">Bollycrossover Collection</h3>
                    </div>
                </div>
          </div>
          <div class="col_one_third">
            <a href="fs1_product_listing.php"><img src="images/artncraft/featurebox/2.jpg" alt="">
            </a>
            <div class="overlayContentBox">
                    <div>
                        <h3 class="nobottommargin text-center">Stylish Wear Collection</h3>
                    </div>
                </div>
          </div>
          <div class="col_one_third col_last">
            <a href="fs1_product_listing.php"><img src="images/artncraft/featurebox/3.jpg" alt="">
            </a>
            <div class="overlayContentBox">
                    <div>
                        <h3 class="nobottommargin text-center">Fancy Wear Collection</h3>
                    </div>
                </div>
          </div>
        </div>
          ...
          <div id="shop" class="shop clearfix">
            <div class="product clearfix">
              <div class="product-image producImgBoxSize_4Col">
                <a href="fs1_product_detail.php"><img src="images/artncraft/products/default-product.jpg" alt="">
                </a>
