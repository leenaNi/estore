            ...
            <div class="container clearfix topmargin-sm">
                    ...
                    <div class="fslider" data-arrows="false">
                        <div class="flexslider">
                            <div class="slider-wrap">
                                <div class="slide">
                                    <a href="#"> <img src="images/beauty-wellness/slider/1.jpg" alt="Shop Image"> 
                                        <div class="flex-caption">
                                            <h2>Transform Your Skin</h2>
                                        </div></a>
                                </div>
                                <div class="slide">
                                    <a href="#"> <img src="images/beauty-wellness/slider/2.jpg" alt="Shop Image"> 
                                        <div class="flex-caption">
                                            <h2>Health is Wealth</h2>
                                        </div></a>
                                </div>
                                <div class="slide">
                                    <a href="#"> <img src="images/beauty-wellness/slider/3.jpg" alt="Shop Image"> 
                                        <div class="flex-caption">
                                            <h2>Body is where you live in</h2>
                                        </div></a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col_one_fourth nobottommargin col_last">
                    ...
                    <div class="col_full bottommargin-26">
                        <a href="#"><img src="images/beauty-wellness/featurebox/1.jpg" alt="">
                        </a>
                        <div class="overlayContentBox">
                            <div>
                                <h3 class="nobottommargin text-center">Love for lipsticks</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col_full bottommargin-26">
                        <a href="#"><img src="images/beauty-wellness/featurebox/2.jpg" alt="">
                        </a>
                        <div class="overlayContentBox">
                            <div>
                                <h3 class="nobottommargin text-center">My city My color</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col_full bottommargin-sm">
                        <a href="#"><img src="images/beauty-wellness/featurebox/3.jpg" alt="">
                        </a>
                        <div class="overlayContentBox">
                            <div>
                                <h3 class="nobottommargin text-center">Direct from Nature</h3>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="shop" class="shop clearfix">
                            ...
                            <div class="product clearfix product-item productbox">
                                <div class="product-image">
                                    <a href="#"><img src="images/beauty-wellness/products/default-product.jpg" alt="">
                                    </a>
