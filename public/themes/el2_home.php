					...
					<div class="col_three_fourth nobottommargin">
						...
						<div class="fslider" data-arrows="false">
							<div class="flexslider">
								...
								<div class="slide">
                <a href="#"> <img src="images/electronics/slider/1.jpg" alt="Shop Image"> 
                <div class="flex-caption">
                                <h2>Ready for savings? Upto 20% off</h2>
                            </div></a>
              </div>
							<div class="slide">
                <a href="#"> <img src="images/electronics/slider/2.jpg" alt="Shop Image"> 
                <div class="flex-caption">
                                <h2>It’s time to shop SMART!</h2>
                            </div></a>
              </div>
							<div class="slide">
                <a href="#"> <img src="images/electronics/slider/3.jpg" alt="Shop Image"> 
                <div class="flex-caption">
					...
					<div class="col_one_fourth nobottommargin col_last">
						...
						<a href="fs2_product_listing.php"><img src="images/electronics/featurebox/1.jpg" alt="">
            </a>
            <div class="overlayContentBox">
                    <div>
                        <h3 class="nobottommargin text-center">Deals of the day</h3>
                    </div>
                </div>
						</div>
						<div class="col_full bottommargin-26">
						<a href="fs2_product_listing.php"><img src="images/electronics/featurebox/2.jpg" alt="">
            </a>
            <div class="overlayContentBox">
                    <div>
                        <h3 class="nobottommargin text-center">Gadgets World</h3>
                    </div>
                </div>
						</div>
						<div class="col_full bottommargin-sm">
						<a href="fs2_product_listing.php"><img src="images/electronics/featurebox/3.jpg" alt="">
            </a>
            <div class="overlayContentBox">
                    <div>
                        <h3 class="nobottommargin text-center">Just Launched</h3>
                    </div>
                </div>
						</div>
			...
			<div class="container clearfix bottommargin-sm">
				...
				<div id="shop" class="shop clearfix">
									...
									<div class="product clearfix product-item productbox">
										...
										<a href="fs2_product_detail.php"><img src="images/electronics/products/default-product.jpg" alt="">
                </a>
