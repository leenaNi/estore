...
class UploadHandler {
    ...
    function __construct($options = null, $initialize = true, $error_messages = null, $path) {
        ...
        $urlForDel = $this->get_full_url() . "/admin/catalog/products/product-bulk-image-upload";
        $this->response = array();
        $this->options = array(
            'script_url' => $urlForDel,
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')) . $path, //'/public/Admin/uploads/catalog/products/',
            'upload_url' => $this->get_full_url() . $path,  //'/public/Admin/uploads/catalog/products/',
