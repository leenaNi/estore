<footer class="main-footer">
    ...
    Powered by <a href="https://estorifi.com" target="_blank" class="wight-color">eStorifi</a>
    </div>
     &copy; <?php echo date("Y"); ?>. All Rights Reserved.
</footer>
<div id="go-to-top"><i class="fa fa-arrow-up"></i></div>
<!-- Modal Open-->
  <div class="modal fade" id="shortcut-popup" role="dialog">
    <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content col-md-12">
        ...
        <div class="modal-body col-md-12 noAllpadding">
...
<!--                  <div class="col-md-12 col-sm-12 noAllpadding marginBottom10">
                ...
                <h4 class="page-header">Adding items to your store</h4>
...
<!--                  <div class="col-md-12 col-sm-12 marginBottom10">
            ...
            <section>
              <div class="col-md-8">  
                ...
                <div class="fontawesome-icon-list">
                  <h4 class="page-header">Navigating your admin panel</h4>
                  <div class="col-md-12 col-sm-12 noAllpadding marginBottom10">
                    <button type="button" class="btn btn-default btn-flat ksbtn">G</button> 
                    <button type="button" class="btn btn-default btn-flat ksbtn">H</button> 
                    Go to Home
                  </div>
                  <div class="col-md-12 col-sm-12 noAllpadding marginBottom10">
                    <button type="button" class="btn btn-default btn-flat ksbtn">G</button> 
...
<!--                  <div class="col-md-12 col-sm-12 noAllpadding marginBottom10">
                  ...
                  <div class="col-md-12 col-sm-12 noAllpadding marginBottom10">
                    <button type="button" class="btn btn-default btn-flat ksbtn">G</button>
                    <button type="button" class="btn btn-default btn-flat ksbtn">N</button>   
                    Go to Analytics
                  </div>
                  <div class="col-md-12 col-sm-12 noAllpadding marginBottom10">
                    <button type="button" class="btn btn-default btn-flat ksbtn">G</button> 
...
<!--                  <div class="col-md-12 col-sm-12 noAllpadding marginBottom10">
                  ...
                  <div class="col-md-12 col-sm-12 noAllpadding marginBottom10">
                    <button type="button" class="btn btn-default btn-flat ksbtn">G</button>
                    <button type="button" class="btn btn-default btn-flat ksbtn">P</button> 
                    <button type="button" class="btn btn-default btn-flat ksbtn">T</button>   
                      Go to Products: Transfers
                  </div>
                  <div class="col-md-12 col-sm-12 noAllpadding marginBottom10">
                    <button type="button" class="btn btn-default btn-flat ksbtn">G</button> 
                    <button type="button" class="btn btn-default btn-flat ksbtn">P</button> 
                    <button type="button" class="btn btn-default btn-flat ksbtn">I</button>   
...
<!--                <div class="col-md-6 noAllpadding">   
                ...
                <div class="fontawesome-icon-list">
                  ...
                  <div class="col-md-12 col-sm-12 noAllpadding marginBottom10">
                    <button type="button" class="btn btn-default btn-flat ksbtn">G</button>
                    <button type="button" class="btn btn-default btn-flat ksbtn">S</button> 
                    <button type="button" class="btn btn-default btn-flat ksbtn">X</button> 
                  ...
                  <div class="col-md-12 col-sm-12 noAllpadding marginBottom10">
                    <button type="button" class="btn btn-default btn-flat ksbtn">G</button> 
                    <button type="button" class="btn btn-default btn-flat ksbtn">S</button> 
                    <button type="button" class="btn btn-default btn-flat ksbtn">F</button>  
