            ...
            <div class="box">
                ...
                <div class="col-md-4 form-group">
                    {!! Form::label('amount', "Order Amount $currencySym",['class'=>'control-label']) !!}<span class="red-astrik"> *</span>
                        {!! Form::text('order_amt','3900', ["class"=>'form-control priceConvertTextBox validate[required,custom[number]]]' ,"placeholder"=>'Order Amount']) !!}
                    
                </div>
               
                <div class="col-md-4 form-group">
                    {!! Form::label('payamount', "Vendor Payable Amount $currencySym",['class'=>'control-label']) !!}<span class="red-astrik"> *</span>
                        {!! Form::text('pay_amt','3900', ["class"=>'form-control priceConvertTextBox validate[required,custom[number]]' ,"placeholder"=>'Vendor Payable Amount']) !!}
