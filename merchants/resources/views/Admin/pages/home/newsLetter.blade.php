        ...
        <div class="col-md-12">
            <div class="box">
                    ...
                    <form action="{{ route('admin.home.saveNewsLetter') }}" method="post" enctype="multipart/form-data" >
                        ...
                        <div class="box-header no-margin">
                            ...
                            <div>
                                ...
                                $checkval = 0;
                                $checked = '';
                                if(isset($result) && $result['is_active'] == 1){
                                    $checkval = 1;
                                    $checked = 'checked';
                                }
                                ?>
                           <!--  <input type="checkbox" name="enablesub" class="enablesub" value="{{ $checkval }}" {{ $checked }}>  -->
                            ...
                            <input type="radio"  id="enablesub" name="enablesub" value=0  {{ ($checkval==0)? "checked" : "" }} >No</label>

                            <input type="radio" id="disablesub" name="enablesub" value=1 {{ ($checkval==1)? "checked" : "" }} >Yes</label>
                            </div>
                        </div>
                        <div class="box-header no-margin">
                            <div class="col-sm-2">
                ...
                <div class="box-header box-tools filter-box col-md-9 noBorder">
                    <form action="{{ route('admin.home.newsletter') }}" method="get" >
                        <input type="hidden" value="searchData" name="searchData" >
                        <div class="form-group col-md-4 noBottomMargin">
                            <input type="text" value="{{ !empty(Input::get('email')) ? Input::get('email') : '' }}" name="email" aria-controls="editable-sample" class="form-control medium" placeholder="Email"/>    
                        </div>
                        <div class="form-group col-md-4 noBottomMargin">
                            <input type="text" value="{{ !empty(Input::get('subscribedID')) ? Input::get('subscribedID') : '' }}" name="subscribedID" aria-controls="editable-sample" class="form-control medium" placeholder=" SubscribedID"/>
                        </div>
                        ...
                        <div class="form-group col-md-2 noBottomMargin">
                            <a href="{{route('admin.home.newsletter')}}" class="btn reset-btn btn-block" value="reset">Reset</a>
                        </div>
