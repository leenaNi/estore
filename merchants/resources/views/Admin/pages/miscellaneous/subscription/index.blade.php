                        ...
                        <tbody>
                            ...
                            <tr> 
                                ...
                                <td class="text-center mn-w100">
                                    <a href="{!! route('admin.subscriptionProgram.editSubscription',['id'=>$set->id]) !!}" data-toggle="tooltip" title="Configure" ui-toggle-class=""><i class="fa fa-cog btnNo-margn-padd" aria-hidden="true"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
