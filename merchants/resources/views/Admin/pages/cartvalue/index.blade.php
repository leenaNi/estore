...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Minimum Cart Value</li>
    </ol>
</section>
        ...
        <div class="box-body table-responsive no-padding">
            <table class="table table-striped table-hover tableVaglignMiddle">
                ...
                <tbody>
                  <tr>
                    <td></td>
                    <td width="40%">{{$charges}}</td>
                    <td>
                        <a href="{{route('admin.cartvalue.edit',['id'=>$id])}}" data-toggle="tooltip" title='Configure' ui-toggle-class=""><i class="fa fa-edit" aria-hidden="true"></i></a> 
                    </td>
                    </tr>
                </tbody>
            </table>
