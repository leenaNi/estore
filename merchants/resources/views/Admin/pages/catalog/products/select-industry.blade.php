        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-header box-tools filter-box col-md-9 col-sm-12 col-xs-12 noBorder">
                    {!! Form::open(['method' => 'post', 'route' => 'selectThemes' , 'id' => 'searchForm' ]) !!}
                    ...
                    <div class="form-group col-md-4 noBottomMargin">
                        <div class=" button-filter-search col-md-6 no-padding">
                            <button type="submit" name="save" class="btn sbtn btn-primary form-control" style="margin-left: 0px;" value="Submit"> Submit</button>
                        </div>
