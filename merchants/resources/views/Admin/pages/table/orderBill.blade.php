...
<!--                        <div class="col-md-12">
                        ...
                        <div class="col-md-10 col-md-offset-2 padd-left10">
                                ...
                                <input type="hidden" name="responseType" value="json" class="responseType">
