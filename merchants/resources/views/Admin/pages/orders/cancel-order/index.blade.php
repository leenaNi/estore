...
<section class="main-content">
    ...
    <div class="grid-content">
        <div class="section-main-heading">
            <h1><img src="{{ Config('constants.adminImgangePath') }}/icons/{{'receipt-2.svg'}}"> Cancel Orders</h1>
        </div>
        <div class="listing-section">
            <div class="table-responsive overflowVisible no-padding">
                <table class="table orderTable table-striped table-hover">
                    <thead>
                        <tr>
                            <th class="text-right">Cancel Order Id</th>
             ...
             ?>
                        ...
                        <tr>
                            <td class="text-right"> {{ @$cancel->id }}</td>
                            <td class="text-right"> {{ @$cancel->getorders->id }}</td>
