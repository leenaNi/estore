...
<section class="content-header">
    <h1>
        All Distributors Orders ({{$ordersCount }})
        <small></small>
    </h1>
    <ol class="breadcrumb">
        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-header box-tools filter-box col-md-9 noBorder rightBorder">
                    {!! Form::open(['method' => 'get', 'route' => 'admin.distributor.orders.view' , 'id' => 'searchForm' ]) !!}
                ...
                <div class="box-header col-md-3 col-xs-12 pull-right mobPadding noMob-leftBorder mob-bottomBorder">
                    <a href="{{route('admin.distributor.orders.new')}}" target="_blank" class="btn btn-default pull-right col-md-12 fullMobile-width">Create New Order</a>
