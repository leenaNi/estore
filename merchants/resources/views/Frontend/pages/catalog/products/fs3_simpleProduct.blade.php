                ...
                <div class="product">
                    <form id="{{"form".$product->id }}" action="{{ route('addToCart') }}">
                        ...
                        <div class="col_last col_half product-desc">
                            ...
                            <button  form-id='{{ $product->id }}'type="button" class="add-to-cart button nomargin addToCartB addToCart mobMB15">Add to cart</button>
                ...
                <div class="col_full nobottommargin">
                    <div class="tabs clearfix nobottommargin" id="tab-1">
                        <ul class="tab-nav clearfix">
                            ...
                            <!-- <li><a href="#tabs-2"> <span class="hidden-xs"> Additional Information</span></a> </li> -->
                        </ul>
                        <div class="tab-container">
                            <div class="tab-content clearfix ProdctDetails" id="tabs-1">
                                <p class="nobottommargin"><?php
                            ...
                            <!-- <div class="tab-content clearfix ProdctDetails" id="tabs-2">
                                <p class="nobottommargin"><?php
                            if (!empty($product->add_desc)) {
                                echo html_entity_decode($product->add_desc);
                            } else {
                                echo "No data found";
                            }
                            ?></p>  
