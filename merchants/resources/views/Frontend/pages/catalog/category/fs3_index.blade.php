...
<div  ng-controller="productListingController">
    <section id="page-title">
        <div class="container clearfix">
            <h1>[[cat.category]]</h1>
            <ol class="breadcrumb" ng-bind-html="breadcrumbs | toTrust">
            </div>
        </section>
        <!-- Content -->
        <section id="content">
            <div class="content-wrap" >
                        ...
                        <div class="sidebar-widgets-wrap"> 
                            <aside class="widget">
                                ...
                                <div class="f-price price-rangebox">
                                    ...
                                    <div class="minPriceBox"><span class="currency-sym"></span> <input type="text" id="min_price" name="min_price" min="0" placeholder="Min price" class="min-price-filter"></div><div class="priceHypen">-</div>
                                        <div class="maxPriceBox"><span class="currency-sym"></span> <input type="text" id="max_price" name="max_price" placeholder="Max price" class="max-price-filter">
                                        </div>
                                ...
                                <div class="widget clearfix notoppadding">
                                    ...
                                    <div ng-repeat="filtername in getfilters">
                                        ...
                                        <div class="acc_content clearfix">
                                            <ul class="cat-list">
                                                <li ng-repeat="(childk, childv) in filtername.childs"><a href="javascript:void(0)">
                                                    <label  class="filtercheckbox">[[childv]] <input  class=" filterChk"  type="checkbox" name="filter[]" ng-model="filteredCheck[childk]" ng-click="filterProds(childk, filtername.filterby)" ng-checked="getPreFilters([[childk]])">
                                                        <span class="checkmark"></span>
                                                    </label>
                                                </a> 
                                            </li>
                ...
                <!-- sidebar end -->
                <div id="shop" class="shop col-md-9 product-3 clearfix bottommargin-sm nopadding" >

                    <div class="product clearfix"  ng-repeat="prd in pdts" ng-if='[[prd.is_stock_status]]==1'>

                        <div class="product-image product-image-listing">
                            <a href="{{ route('home')}}/[[prd.url_key]]"><img src="[[prd.mainImage]]" alt="[[prd.alt_text]]"> </a>
                            <a href="{{ route('home')}}/[[prd.url_key]]"><img  src="[[prd.mainImage]]" alt="[[prd.alt_text]]"> </a>
                            <div class="product-overlay"> <a href="{{ route('home')}}/[[prd.url_key]]" class="add-to-cart"><i class="icon-eye"></i><span> View Detail</span></a> </div>
                        </div>
                        <div class="product-desc">
                            <div class="product-title">
                                <h3><a href="{{ route('home')}}/[[prd.url_key]]">[[prd.product]]</a></h3> </div>
                        ...
                        <div class="text-center col-md-12">
                            <a href="#" class="button button-large button-dark topmargin-xs" ng-if="nextpageurl != null"  ng-click="load($event, nextpageurl)">Load More</a>
                            <!--<a href="#" class="button button-large button-dark  topmargin-sm">Load More</a>--> 
                        </div>

                        <div class="content-wrap text-center col-md-12" ng-show="pdts.length == 0">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            maxp = <?php echo (@$maxp) ? $maxp * Session::get('currency_val') : '0'; ?>;
            maxp = Math.ceil(maxp);
            console.log("fs3Min price => " + minp + "Max price => " + maxp);
