                                                    ...
                                                    <li ng-if="billSummary.orderCount <= 0">
                                                        <div ng-if="billSummary.checkReferral == 1" >
                                                            ...
                                                            <div class="form-group"  >
                                                                ...
                                                                <label for="email" class="col-md-12">REFERRAL
                                                                    <span class="referalMsg pull-right" style="color: red; font-size: 13px; font-weight: normal; text-transform: none;" ></span></label>
