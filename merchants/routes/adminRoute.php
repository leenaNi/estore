...
//
        ...
        Route::post('/purchase-vs-sales-stat', ["as" => "admin.dashboard.purchaseSalesStat", "uses" => "PagesController@purchaseVsSalesStat"]);
    ...
    Route::group(['prefix' => 'distributor', 'middlewareGroups' => ['CheckUser', 'web']], function () {
        ...
        //Route::get('/accept/{id}', array('as' => 'admin.vendors.accept', 'uses' => 'DistributorController@approveRequest'));
    });
